...
ActiveRecord::Schema.define(version: 20140806215209) do
  ...
  add_index "lectures_professors", ["reference_number"], name: "index_lectures_professors_on_reference_number", using: :btree
